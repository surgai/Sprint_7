...
class TestLoginCourier:
    ...
    def test_courier_log_in(self):
        ...
        response = requests.post(f'{Urls.URL}{LOGIN_COURIER}', data=Users.data_current)
        print(response.text)
    ...
    def test_courier_log_negative(self):
        LOGIN_COURIER = "/api/v1/courier/login"
        response = requests.post(f'{Urls.URL}{LOGIN_COURIER}', data=Users.data_negative)
    ...
    def test_courier_log_not_all_data(self, data_without_login_or_password):
        LOGIN_COURIER = "/api/v1/courier/login"
        response = requests.post(f'{Urls.URL}{LOGIN_COURIER}', data=data_without_login_or_password)
